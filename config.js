...
module.exports = {
    ...
    ALIVEBTN: process.env.ALIVE_BUTTON === undefined ? 'ᴇɴɢᴀɴᴇʏᴜɴᴅ ᴀʙᴜsᴇʀ🌝' : process.env.ALIVE_BUTTON,
    ...
    OWNER: process.env.OWNER_NAME === undefined ? '💖Abu and Jasil💖' : process.env.OWNER_NAME,
    BC: process.env.BROADCAST_NAME === undefined ? 'ꪶ͢ɪͥᴛͭsᷤ ͢ᴍͫᴇͤᡃ⃝✰ͣᴀͫʙᴜ✰⁩' : process.env.BROADCAST_NAME,
    PHONE: process.env.NUMBER === undefined ? '+917025994178' : process.env.NUMBER,   
    OA_NAME: process.env.DEPLOYER === undefined ? 'Abu-Jasil' : process.env.DEPLOYER,
    ...
    LG_LOGO: process.env.LG_LOGO === undefined ? 'https://www.linkpicture.com/q/IMG-20220108-WA0143.jpg' : process.env.LG_LOGO,
    LOGO_NAME: process.env.LOGO_NAME === undefined ? 'ABU_SER-V3' : process.env.LOGO_NAME,
    ...
    LOGOSK: process.env.ALL_IMG === undefined ? 'https://www.linkpicture.com/q/IMG-20220108-WA0143.jpg' : process.env.ALL_IMG,
