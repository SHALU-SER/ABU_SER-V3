...
Maalutty.addCommand({pattern: 'git', fromMe: false, desc: Lang.WP}, (async (message, match) => {
    ...
    await message.sendMessage(Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: `◄━⦁💝 ABUSER_V3💝⦁━►
...
*Oᴡɴᴇʀ Iᴅ ɪɴsᴛᴀɢʀᴀᴍ* :https://instagram.com/_.jasil_rx?utm_medium=copy_link


*Gɪᴛᴜʙ* : https://github.com/ABUOP1/ABU_SER-V3.


*Aᴜᴅɪᴏ Cᴏᴍᴍᴀɴᴅs* :https://github.com/ABUOP1/media/tree/main/bgm.


*Sᴛɪᴄᴋᴇʀ Cᴏᴍᴍᴀɴᴅs* :https://github.com/ABUOP1/media/tree/main/stickers.
