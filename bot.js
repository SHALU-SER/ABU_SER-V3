...
${chalk.blue.italic('ℹ️ Connecting to WhatsApp...')}`);
          ...
          if (config.LANG == 'EN' || config.LANG == 'ML') {
                ...
                if (commits.total === 0) {
                    ...
                    await conn.sendMessage(
                        conn.user.jid,
                        '*◄━⦁💝 ABU_SER-V3💝⦁━►*' + degisiklikler + '```', MessageType.text
                    ); 
                } 
          }
    });//thanx afnanplk
    setInterval(async () => { 
        ...
        var ansk = 'https://gist.githubusercontent.com/ABUOP1/6b2380925622a31745dedec7e3c0a5a0/raw'
